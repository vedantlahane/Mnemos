...
def get_groq_llm(model: str = None, temperature: float = 0.1) -> ChatGroq:
    return ChatGroq(
...
async def groq_json_call(prompt: str, model: str = None) -> dict | list:
    llm = get_groq_llm(model=model, temperature=0.1)
    messages = [
